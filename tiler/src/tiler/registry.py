...
affects tile rendering. Index partition ids match the source registry's
...
class Layer:
    id: str
    collection: str  # index partition id
...
# single canonical index; see settings.index_path.
LAYERS: dict[str, Layer] = {
    ...
    # at 60 cm-1 m, but the index shows 2022+ vintages at 30 cm (verified:
