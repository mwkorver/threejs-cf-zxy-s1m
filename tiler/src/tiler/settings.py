...
class Settings(BaseSettings):
    ...
    lake_path: str = "s3://deckgl-s3-cog-s1m-000000000000-us-west2/lake"

    # S1M DEM tile lookup (plan §4.2); built by the source repo's
    # publish-s1m-index.sh. Geometry/bbox are EPSG:6350 Albers.
    s1m_index_path: str = "s3://deckgl-s3-cog-s1m-000000000000-us-west2/lake/s1m/S1M_Products.parquet"
